...
SFTP_ROOT = '/mnt/149.202.77.202_remote/PTulip_Admin/'
...
TMP_PROCESSING = os.path.join('/var/lib/vz/VidComp_Zone/tmp_input', 'processing')

TMP_OUTPUT_ROOT = '/var/lib/vz/VidComp_Zone/tmp_output_av1_crf{}'   # Format string for CRF values
FINAL_OUTPUT_ROOT = '/mnt/149.202.77.202_remote/PTulip_Admin_AV1_crf{}'  # Format string for CRF values
